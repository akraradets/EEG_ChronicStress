...
\begin{figure}[h!]
    \caption{10-CV score of both SVM and LR classifier when using different rank at different number of features. A line plot show the trend of 10-CV when increasing the number of feature based on ranks. The bar plot shows the 10-CV score at the number of feature, 6 for SVM and 9 for LR.}
    \label{fig:cv_svm-lr}
